...
setup(
    ...
    entry_points={
        'console_scripts': [
            'spirit_node = nav2_simple_commander.spirit_node:main',
            'example_spirit_through_poses = nav2_simple_commander.example_spirit_through_poses:main',
            ...
            'demo_home = nav2_simple_commander.demo_home:main',
            ...
            'nav_executor = nav2_simple_commander.nav_executor:main',
        ],
    },
)
