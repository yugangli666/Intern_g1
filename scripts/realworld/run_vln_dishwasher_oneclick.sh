...
HELP
    ...
    if health_ok; then
        ...
        server_cmd="cd \"$PROJECT_ROOT\" && SKIP_RUNTIME_INSTALL=\"$SKIP_RUNTIME_INSTALL\" INTERNNAV_ALLOW_EAGER_ATTN=\"$INTERNNAV_ALLOW_EAGER_ATTN\" exec bash docker_start_server_in_container.sh"
